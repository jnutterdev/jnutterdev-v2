...
tags:
  ...
  - atproto
  - Astro
mastodonUrl: https://mastodon.social/@jnutterdev/116932579853683489
blueskyUrl: https://bsky.app/profile/jnutter.dev/post/3mqsk36b6d427
---
...
4. Because the site is a static Astro build, the page HTML can't reflect replies that show up after deploy. So the fetch happens client-side in a small vanilla JS `<script>` tag — the component ships a "Loading replies…" placeholder that gets swapped for the real thread (or a "no replies yet" state) the moment the browser fetches it.
