---
title: "jnutterdev.com v2"
description: "The redesigned portfolio — Astro for full static output, Tina CMS for git-backed editorial control, deployed via GitHub Actions rsync to a self-hosted VPS. Zero JS on load."
tech: ["Astro", "Tina CMS", "CSS", "CI/CD"]
status: "active"
github_url: "https://github.com/jnutterdev/jnutterdev-v2"
live_url: "https://jnutterdev.com"
order: 1
featured: true
---
...
Push to `main` → GitHub Actions builds (`npm run build`) → rsync to VPS over SSH. Tina edits trigger the same pipeline automatically via the same commit hook.
